      ...
      >
        {tabs.map((tab) => (
          <div
            ...
            className={`
              group relative flex min-h-8 w-full touch-none items-center px-2.5 py-1 rounded-md transition-colors
              text-xs font-medium select-none
              ${draggedTabId === tab.id ? "cursor-grabbing opacity-50" : "cursor-default"}
              ${
                tab.id === activeTabId
